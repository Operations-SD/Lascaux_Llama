...
{
    public partial class InterviewInbox

    {
        ...
        [Inject]
        private QuestionService question1 { get; set; }
        ...
        private void CreateMemo()
        {
            ...
            message = message + "\nThis is the question: " + question1._currentQuestion.QuestionText + "\n Label is : "+question1.Label;
            List<SqlParameter> parameters = new List<SqlParameter>
            {
                ...
                new SqlParameter("@memo_priority", priorityType),
        ...
        private void LoadMemos(string sp, string table)
        {
            ...
            while (reader.Read())
            {
                ...
                // Check if memo_image column exists and is not null
